...
DataBrowser *DataEditDialogHelper::browser() const
{
    return m_edit->browser();
}

void DataEditDialogHelper::setBrowser(DataBrowser *interface)
{
    m_edit->setBrowser(interface);
}
