...
public:
    ...
    void fetchSuggestions(const DataQuery &query, const DataQueryResponseCallback &onResponse);
    void fetchSuggestions(const DataQuery &query, const DataQueryProgressCallback &onProgress, const DataQueryResponseCallback &onResponse);
    ...
    virtual void fetchSomeSuggestions(const DataQuery &query, const DataQueryProgressCallback &onProgress, const DataQueryResponseCallback &onResponse);
